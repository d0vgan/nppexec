...
:Building
cd .\NppExec
msbuild NppExec_VC2022.sln /t:Clean /p:Configuration=Release;Platform=x64 /m:2
msbuild NppExec_VC2022.sln /t:Build /p:Configuration=Release;Platform=x64 /m:2
goto End
