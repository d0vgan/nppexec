...
cd ..
%ARC_EXE% u -tzip ..\%ARC_DLL_NAME%.zip doc\NppExec\NppExec.txt doc\NppExec\NppExec_TechInfo.txt doc\NppExec\NppExec*.chm doc\NppExec\*.html doc\NppExec\*.css doc\NppExec\*.png -mx5
cd ..
...
cd ..\..
%ARC_EXE% u -tzip ..\%ARC_DLL_NAME_64%.zip doc\NppExec\NppExec.txt doc\NppExec\NppExec_TechInfo.txt doc\NppExec\NppExec*.chm doc\NppExec\*.html doc\NppExec\*.css doc\NppExec\*.png -mx5
cd Release
